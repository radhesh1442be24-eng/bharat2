  ...
  return (
    <div className="bg-white rounded-md shadow-xs border border-[#D9E1EA] overflow-hidden text-[#172033]">
      ...
      <div className="bg-blue-50/70 px-4 py-2 border-b border-blue-100 flex items-center gap-2 text-[11px] text-blue-950 font-normal">
        ...
        <span>
          <strong>Fitment Note:</strong> Calculated alternative — verify vehicle fitment before purchase. Always check wheel arch clearances and load indexes.
        </span>
      </div>

      {/* Recommendation Status Legend */}
      <div className="bg-[#F8FAFC] px-4 py-2.5 border-b border-[#D9E1EA] flex flex-wrap items-center justify-between gap-2 text-xs">
                    ...
                    {isExpanded && (
                      <tr className="bg-slate-50/90 border-b border-[#D9E1EA]">
                        <td colSpan="8" className="p-4">
                          <div className="bg-white border border-[#D9E1EA] rounded-md p-3.5 shadow-2xs">
                            <div className="flex items-center justify-between pb-2 border-b border-[#E2E8F0] mb-2.5">
                              <span className="text-xs font-bold text-[#172033] flex items-center gap-1.5">
                                <Info className="w-4 h-4 text-[#087FEA]" />
                                <span>7-Stage Fitment Analysis for {item.sizeString}</span>
                              </span>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
                              ...
                              <div className="flex flex-col gap-1.5">
                                <span className="font-semibold text-slate-700 text-[11px]">Screening Details & Reasons:</span>
                              ...
                              {/* Rim Width & Engineering Specs */}
                              <div className="flex flex-col gap-1.5 bg-[#F8FAFC] p-2.5 rounded border border-[#E2E8F0] text-[11px]">
                                <span className="font-semibold text-slate-800">Engineering Fitment Metrics:</span>
                                <div className="flex justify-between">
                                  <span className="text-slate-500">Recommended Rim Width:</span>
                                  <span className="font-semibold">{item.screening?.recommendedRimRange?.min}&quot; - {item.screening?.recommendedRimRange?.max}&quot;</span>
                                </div>
                                <div className="flex justify-between">
                                  <span className="text-slate-500">Speedometer Difference:</span>
                                  <span className="font-semibold">{item.speedometer100.toFixed(1)} km/h @ 100 km/h</span>
                                </div>
                                <div className="flex justify-between">
                                  <span className="text-slate-500">Revolutions / km:</span>
                                  <span className="font-semibold">{item.revsPerKm.toFixed(1)}</span>
                                </div>
                                <div className="mt-1 pt-1.5 border-t border-[#E2E8F0] text-[10px] text-slate-500 italic">
